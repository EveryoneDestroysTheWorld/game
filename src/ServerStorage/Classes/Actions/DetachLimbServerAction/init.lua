...
local IDetachLimbServerAction = require(ServerStorage.Interfaces.IDetachLimbServerAction);
...
type IDetachLimbServerAction = IDetachLimbServerAction.IDetachLimbServerAction;
...
function DetachLimbServerAction.new(contestant: IServerContestant): IDetachLimbServerAction
  
  local detachedLimbs: {[string]: BasePart | Model} = {};
  contestant.attributes.detachedLimbs = detachedLimbs;

  local function activate(self: IDetachLimbServerAction, limbName: string?)
    ...
    contestant:addBaseModifier("Health", {
      delta = -19;
      cause = {
        actionID = self.id;
      };
  ...
  local function breakdown(self: IDetachLimbServerAction)
  
    for _, detachedLimb in detachedLimbs do
  ...
  local action: IDetachLimbServerAction = {
