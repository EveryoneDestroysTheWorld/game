...
function HeresThePitchClientAction.new(): types.HeresThePitchClientAction
  ...
  action.remoteFunction.OnClientInvoke = function(step: "CopyWeld" | "Throw", ballName: string)
...
function HeresThePitchClientAction.__index:activate()
